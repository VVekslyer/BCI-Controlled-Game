# This script collects user EEG data for 30 seconds and then calculates 
# thresholds beta_min, beta_max and beta_avg.
# Each user will have different levels of brain activity,
# users with lower levels may have difficulty accelerating the car,
# and may therefore need a lower threshold. 
# We will use the beta_avg as our feedback threshold.
